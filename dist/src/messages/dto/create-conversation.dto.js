...
exports.RemoveMemberDto = exports.AddMembersDto = exports.UpdateGroupConversationDto = exports.CreateGroupConversationDto = exports.CreatePrivateConversationDto = exports.ConversationTypeDto = void 0;
...
exports.UpdateGroupConversationDto = UpdateGroupConversationDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'New Group Name' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateGroupConversationDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'https://example.com/new-avatar.jpg' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateGroupConversationDto.prototype, "avatar", void 0);
class AddMembersDto {
}
exports.AddMembersDto = AddMembersDto;
__decorate([
    (0, swagger_1.ApiProperty)({ example: ['userId1', 'userId2'], description: 'Member IDs to add' }),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ArrayMinSize)(1),
    (0, class_validator_1.IsString)({ each: true }),
    __metadata("design:type", Array)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'userId123', description: 'User ID to remove' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
