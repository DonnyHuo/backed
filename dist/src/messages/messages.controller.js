...
let MessagesController = class MessagesController {
    ...
    updateConversation(conversationId, user, dto) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update group conversation (name, avatar)' }),
    __param(0, (0, common_1.Param)('conversationId')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, create_conversation_dto_1.UpdateGroupConversationDto]),
    __metadata("design:returntype", void 0)
], MessagesController.prototype, "updateConversation", null);
__decorate([
    (0, common_1.Post)('conversations/:conversationId/members'),
    (0, swagger_1.ApiOperation)({ summary: 'Add members to group conversation' }),
    __param(0, (0, common_1.Param)('conversationId')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
